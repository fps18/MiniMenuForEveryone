...
namespace CTRPluginFramework
{
    ...
    void Implementation_MiniMenu (const std::string &str, u32 major, u32 minor, u32 revision, u32 Button, bool Optimize)
    {    
            ...
            if(i + scroll < MiniMenuOverview::Entry.size()){
                ...
                if (MiniMenuOverview::Entry[i + scroll].type == 0)      //CheckBox
                {
                    ...
                    if (MiniMenuOverview::Entry[i + scroll].ProgramRunning) 
                    {
                        ...
                        {
                            //有効時の描写(非軽量化)
                            screen.DrawPixel(xPos_CheckBox + 7, yPos_CheckBox +  1 + (15 * i), Color::LimeGreen);//Top
                            screen.DrawPixel(xPos_CheckBox + 7, yPos_CheckBox +  2 + (15 * i), Color::LimeGreen);// s
                            screen.DrawPixel(xPos_CheckBox + 6, yPos_CheckBox +  3 + (15 * i), Color::LimeGreen);// s
                            screen.DrawPixel(xPos_CheckBox + 5, yPos_CheckBox +  4 + (15 * i), Color::LimeGreen);// s
                            screen.DrawPixel(xPos_CheckBox + 4, yPos_CheckBox +  5 + (15 * i), Color::LimeGreen);// s
                            screen.DrawPixel(xPos_CheckBox + 3, yPos_CheckBox +  6 + (15 * i), Color::LimeGreen);// s
                            screen.DrawPixel(xPos_CheckBox + 2, yPos_CheckBox +  5 + (15 * i), Color::LimeGreen);// s
                            screen.DrawPixel(xPos_CheckBox + 6, yPos_CheckBox +  2 + (15 * i), Color::LimeGreen);//ss
                            screen.DrawPixel(xPos_CheckBox + 5, yPos_CheckBox +  3 + (15 * i), Color::LimeGreen);//ss
                            screen.DrawPixel(xPos_CheckBox + 4, yPos_CheckBox +  4 + (15 * i), Color::LimeGreen);//ss
                            screen.DrawPixel(xPos_CheckBox + 3, yPos_CheckBox +  5 + (15 * i), Color::LimeGreen);//ss
                            screen.DrawPixel(xPos_CheckBox + 2, yPos_CheckBox +  6 + (15 * i), Color::LimeGreen);//ss
                            screen.DrawPixel(xPos_CheckBox + 1, yPos_CheckBox +  5 + (15 * i), Color::LimeGreen);//ss
                        }
                        else
                        {
                            //有効時の描写(軽量版)
                            screen.DrawRect(xPos_CheckBox + 1, yPos_CheckBox + 1 + (15 * i), 7, 7, Color::LimeGreen);
                        }
                    }
                }
                else if (MiniMenuOverview::Entry[i + scroll].type == 1) //チェック不可
                {
                    ...
                    {
                        //軽量
                        screen.DrawRect(xPos_CheckBox, yPos_CheckBox + (15 * i), 9, 9, Color::Yellow);
                    }
                }
